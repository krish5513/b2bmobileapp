...
public class TripSheetReturnsBean {
    ...
    public String getmTripshhetReturnsTrip_id() {
        return mTripshhetReturnsTrip_id;
    }
    ...
    public String getmTripshhetReturnsUser_id() {
        return mTripshhetReturnsUser_id;
    }

    public void setmTripshhetReturnsUser_id(String mTripshhetReturnsUser_id) {
        this.mTripshhetReturnsUser_id = mTripshhetReturnsUser_id;
    }

    public String getmTripshhetReturnsUser_codes() {
        return mTripshhetReturnsUser_codes;
    }

    public void setmTripshhetReturnsUser_codes(String mTripshhetReturnsUser_codes) {
        this.mTripshhetReturnsUser_codes = mTripshhetReturnsUser_codes;
    }

    public String getmTripshhetReturnsRoute_id() {
        return mTripshhetReturnsRoute_id;
    }

    public void setmTripshhetReturnsRoute_id(String mTripshhetReturnsRoute_id) {
        this.mTripshhetReturnsRoute_id = mTripshhetReturnsRoute_id;
    }

    public String getmTripshhetReturnsRoute_codes() {
        return mTripshhetReturnsRoute_codes;
    }

    public void setmTripshhetReturnsRoute_codes(String mTripshhetReturnsRoute_codes) {
        this.mTripshhetReturnsRoute_codes = mTripshhetReturnsRoute_codes;
    }

    public String getmTripshhetReturnsProduct_ids() {
        return mTripshhetReturnsProduct_ids;
    }

    public void setmTripshhetReturnsProduct_ids(String mTripshhetReturnsProduct_ids) {
        this.mTripshhetReturnsProduct_ids = mTripshhetReturnsProduct_ids;
    }

    public String getmTripshhetReturnsProduct_codes() {
        return mTripshhetReturnsProduct_codes;
    }
    ...
    public String getmTripshhetReturnsQuantity() {
        return mTripshhetReturnsQuantity;
    }
    ...
    public String getmTripshhetReturnsType() {
        return mTripshhetReturnsType;
    }

    public void setmTripshhetReturnsType(String mTripshhetReturnsType) {
        this.mTripshhetReturnsType = mTripshhetReturnsType;
    }

    public String getmTripshhetReturnsStatus() {
        return mTripshhetReturnsStatus;
    }

    public void setmTripshhetReturnsStatus(String mTripshhetReturnsStatus) {
        this.mTripshhetReturnsStatus = mTripshhetReturnsStatus;
    }

    public String getmTripshhetReturnsDelete() {
        return mTripshhetReturnsDelete;
    }

    public void setmTripshhetReturnsDelete(String mTripshhetReturnsDelete) {
        this.mTripshhetReturnsDelete = mTripshhetReturnsDelete;
    }

    public String getmTripshhetReturnsCreated_by() {
        return mTripshhetReturnsCreated_by;
    }

    public void setmTripshhetReturnsCreated_by(String mTripshhetReturnsCreated_by) {
        this.mTripshhetReturnsCreated_by = mTripshhetReturnsCreated_by;
    }

    public String getmTripshhetReturnsCreated_on() {
        return mTripshhetReturnsCreated_on;
    }

    public void setmTripshhetReturnsCreated_on(String mTripshhetReturnsCreated_on) {
        this.mTripshhetReturnsCreated_on = mTripshhetReturnsCreated_on;
    }

    public String getmTripshhetReturnsUpdated_on() {
        return mTripshhetReturnsUpdated_on;
    }

    public void setmTripshhetReturnsUpdated_on(String mTripshhetReturnsUpdated_on) {
        this.mTripshhetReturnsUpdated_on = mTripshhetReturnsUpdated_on;
    }

    public String getmTripshhetReturnsUpdated_by() {
        return mTripshhetReturnsUpdated_by;
    }

    public void setmTripshhetReturnsUpdated_by(String mTripshhetReturnsUpdated_by) {
